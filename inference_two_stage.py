...
class ImageGenerator:
    def __init__(
        ...
        self.ae, self.dit = load_generator(
            dit_path=dit_path,
            ae_path=ae_path,
            dtype=dtype,
            device=self.device,
...
class ImageConditioner:
    def __init__(
        ...
        self.ae, self.llm_encoder = load_conditioner(
    ...
    def offload(self):
        self.ae.to("cpu")
        self.llm_encoder.to("cpu")
        cudagc()
    
    def load(self):
        self.ae.to(self.device)
        self.llm_encoder.to(self.device)